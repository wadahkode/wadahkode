...
const urlsToCache = [
  ...
  '/id/about.html',
  '/id/tools',
  '/id/assets/avatar/me.jpg',
  '/id/assets/avatar/no-image.png',
  //'/assets/images/*/*',
  '/id/vendor/fontawesome/js/all.min.js',
  //'/vendor/fontawesome/*/*',
  '/id/vendor/jquery/dist/jquery.min.js',
  '/id/vendor/uikit/css/uikit.css',
  '/id/vendor/uikit/js/uikit.min.js',
  '/id/vendor/uikit/js/app.min.js',
  '/id/favicon.jpg'
];
