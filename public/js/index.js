...
const showTutorial = () => {
  ...
  let before = tutorial.hasChildNodes("before")
      ? tutorial.querySelector(".before")
      : null,
    after = tutorial.hasChildNodes("after")
      ? tutorial.querySelector(".after")
      : null,
    date = new Date(),
  ...
  setTimeout(() => {
    if (before == null) {
      ...
      if (
        !before.classList.contains("hidden") &&
        typeof after.querySelector(".remove-tag") != undefined
      ) {
